...
FF.make_action_count_feature("loggedin", "n_logins", end_date=cutoff)
FF.make_action_count_feature("viewed", "n_viewed", end_date=cutoff)
FF.make_event_count_feature("\mod_forum\event\post_created", "n_posts_created", end_date=cutoff)
FF.make_time_since("loggedin", "last_login", end_date=cutoff)
FF.make_event_count_feature("\core\event\message_sent", "n_msg_sent", end_date=cutoff)
...
print "MF df ~ y"
wk0_model = MF.fit_model(df.values,y.values)
...
print "MF df ~ y"
wk1_model = MF.fit_model(df.values,y.values)
MF.fit_tree_model(df.values,y.values)
MF.fit_SVC(df.values,y.values)
# print "MF df ~ y_wk2"
...
print "MF df ~ y"
wk2_model = MF.fit_model(df.values,y.values)
MF.fit_tree_model(df.values,y.values)
MF.fit_SVC(df.values,y.values)
# print "MF df ~ y_wk2"
# MF.fit_model(df.values,y_wk2.values)
...
# wk3 req
FF.make_completion_feature(55017, '3_quiz', cutoff)
FF.make_completion_feature(55013, '3_book', cutoff)
FF.make_completion_feature(55016, '3_forum', cutoff)
FF.make_completion_feature(55014, '3_data', cutoff)
FF.make_completion_feature(55012, '3_page_1', cutoff)
FF.make_completion_feature(55015, '3_page_2', cutoff)
...
print "MF df ~ y"
wk3_model = MF.fit_model(df.values,y.values)
MF.fit_tree_model(df.values,y.values)
MF.fit_SVC(df.values,y.values)
# print "MF df ~ y_wk2"
# MF.fit_model(df.values,y_wk2.values)
